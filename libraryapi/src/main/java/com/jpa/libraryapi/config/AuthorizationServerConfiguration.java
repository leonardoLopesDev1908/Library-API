...
import com.jpa.libraryapi.security.CustomAuthentication;
...
public class AuthorizationServerConfiguration {
    ...
    public TokenSettings tokenSettings(){
        return TokenSettings.builder()  
                ...
                .accessTokenTimeToLive(Duration.ofMinutes(60))//utilizado nas requests
                .refreshTokenTimeToLive(Duration.ofMinutes(90))// utilizado pra renovar o access
                .build();
    }
    ...
    public AuthorizationServerSettings authorizationServerSettings(){
        return AuthorizationServerSettings
            ...
            .tokenIntrospectionEndpoint("/oauth2/introspect")//status do token
            .tokenRevocationEndpoint("/oauth2/revoke")//revogar token
            .authorizationEndpoint("/oauth2/authorize")
            .oidcUserInfoEndpoint("/oauth2/userinfo")//infos do user
